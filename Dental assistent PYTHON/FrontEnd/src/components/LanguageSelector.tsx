        ...
        <div className="w-full space-y-3">
          ...
          <button
            ...
            className={`w-full flex items-center gap-4 p-4 rounded-xl border-2 transition-all duration-300 ${
              language === "en"
                ? "border-[#35a7d3] bg-[#35a7d3]/5 shadow-lg shadow-[#35a7d3]/10"
                : "border-[#e2e8f0] bg-white/80 hover:border-[#35a7d3]/50 hover:bg-white"
            }`}
          >
            ...
            <div className="flex-1 text-left">
              <p className={`font-semibold ${language === "en" ? "text-[#35a7d3]" : "text-[#1e293b]"}`}>
                English
              </p>
              <p className="text-sm text-[#64748b]">United Kingdom</p>
            </div>
            {language === "en" && (
              <div className="w-6 h-6 rounded-full bg-[#35a7d3] flex items-center justify-center">
          ...
          >
            ...
            <div className="flex-1 text-left">
              <p className={`font-semibold ${language === "fr" ? "text-[#35a7d3]" : "text-[#1e293b]"}`}>
                Français
              </p>
